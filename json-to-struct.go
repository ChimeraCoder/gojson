...
func Generate(input io.Reader, parser Parser, structName, pkgName string, tags []string, subStruct bool, convertFloats bool, comment bool) ([]byte, error) {
	...
	if comment {
		src = "// Code generated by gojson. DO NOT EDIT.\n\n\n" + src
	}
